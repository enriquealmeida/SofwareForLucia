...
!0)},"change.bootstrapSwitch":function(b,c){b.preventDefault();b.stopImmediatePropagation();var f=a.$element.is(":checked");a._containerPosition(f);f===a.options.state||(a.options.state=f,a.$wrapper.toggleClass(a._getClass("off")).toggleClass(a._getClass("on")),!c&&(a.$element.is(":radio")&&d('[name\x3d"'+a.$element.attr("name")+'"]').not(a.$element).prop("checked",!1).trigger("change.bootstrapSwitch",!0),a.$element.trigger("switchChange.bootstrapSwitch",[f])))},"focus.bootstrapSwitch":function(b){b.preventDefault();
...
f}();d.fn.bootstrapSwitch=function(f){for(var a=arguments.length,b=Array(1<a?a-1:0),c=1;c<a;c++)b[c-1]=arguments[c];return Array.prototype.reduce.call(this,function(a,c){var e=d(c),g=e.data("bootstrap-switch"),h=g||new k(c,f);return g||e.data("bootstrap-switch",h),"string"==typeof f?h[f].apply(h,b):a},this)};d.fn.bootstrapSwitch.Constructor=k;d.fn.bootstrapSwitch.defaults={state:!0,size:null,animate:!0,disabled:!1,readonly:!1,indeterminate:!1,inverse:!1,radioAllOff:!1,onColor:"primary",offColor:"default",
onText:"ON",offText:"OFF",labelText:"\x26nbsp",handleWidth:"auto",labelWidth:"auto",baseClass:"bootstrap-switch",wrapperClass:"wrapper",onInit:function(){},onSwitchChange:function(){}}});function Switch(e){this.Value;this.CheckedValue;this.UncheckedValue;this.Checked;this.Visible;this.Enabled;this.OnText;this.OffText;var g,h,d,k;this.SetAttribute=function(d){this.SetValue(d)};this.GetAttribute=function(){return this.Value};this.SetValue=function(d){this.Checked="boolean"===typeof d?d==gx.lang.booleanValue(this.CheckedValue):this.CheckedValue==d;this.Value=d};this.SetState=function(d){this.Value=d?this.CheckedValue:this.UncheckedValue;this.Checked=d};this.show=function(){this.IsPostBack?
(d.bootstrapSwitch("readonly",!this.Enabled),d.bootstrapSwitch("state",this.Checked,!1),k.toggle(this.Visible)):setTimeout(this.init.closure(this),0)};this.init=function(){g=e(this.getContainerControl());h=this.ContainerName.replace(this.DesignContainerName,this.DesignContainerName.replace(/Container$/,""));var f=Mustache.to_html("\x3cinput type\x3d'checkbox' id\x3d'{{id}}'/\x3e",{id:h});this.setHtml(f);f={size:"small",onColor:"success on",offColor:"default off",wrapperClass:"wrapper gx-switch-"+
this.Class,readonly:!this.Enabled,state:this.Checked,onText:this.OnText,offText:this.OffText};d=e("#"+h).bootstrapSwitch(f);var a=this;d.on("switchChange.bootstrapSwitch",function(b,c){a.SetState(c);a.ControlValueChanged&&a.ControlValueChanged()});k=d.closest(".form-group");k.length||(k=g);k.toggle(this.Visible)}};
