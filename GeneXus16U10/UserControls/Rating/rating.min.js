/*
 * Rating GeneXus User Control 0.0.0.135302
 *
 * Copyright 2016, GeneXus
 */
!function(d){"function"==typeof define&&define.amd?define(["jquery"],d):"object"==typeof module&&module.exports?module.exports=d(require("jquery")):d(window.jQuery)}(function(d){d.fn.ratingLocales={};var e,k,g,m,h,f,n;e=function(a,c){return null===a||void 0===a||0===a.length||c&&""===d.trim(a)};k=function(a,c){a.removeClass(c).addClass(c)};g=function(a,c,b){return(a=e(a.data(c))?a.attr(c):a.data(c))?a:b[c]};m=function(a){return(a=(""+a).match(/(?:\.(\d+))?(?:[eE]([+-]?\d+))?$/))?Math.max(0,(a[1]?
a[1].length:0)-(a[2]?+a[2]:0)):0};h=function(a,c){return parseFloat(a.toFixed(c))};f=function(a,c,b,l){c=l?c:c.split(" ").join(".rating ")+".rating";a.off(c).on(c,b)};n=function(a,c){this.$element=d(a);this.init(c)};n.prototype={constructor:n,_parseAttr:function(a,c){var b,l,d;l=this.$element;d=l.attr("type");if("range"===d||"number"===d){switch(l=g(l,a,c),a){case "min":d=0;break;case "max":d=5;break;default:d=.5}return b=e(l)?d:l,parseFloat(b)}return parseFloat(c[a])},setDefault:function(a,c){e(this[a])&&
...
(c=this.cache,this.toggleHover(c),this.$element.trigger("rating.hoverleave",["clear"]))},resetForm:function(a){a&&a.isDefaultPrevented()||this.inactive||this.reset()},initTouch:function(a){this.setTouch(a,"touchend"===a.type)},listen:function(){var a=this.$element.closest("form"),c=this.$rating,b=this.$clear;f(c,"touchstart touchmove touchend",d.proxy(this.initTouch,this));f(c,"click touchstart",d.proxy(this.starClick,this));f(c,"mousemove",d.proxy(this.starMouseMove,this));f(c,"mouseleave",d.proxy(this.starMouseLeave,
this));f(b,"click touchstart",d.proxy(this.clearClick,this));f(b,"mousemove",d.proxy(this.clearMouseMove,this));f(b,"mouseleave",d.proxy(this.clearMouseLeave,this));a.length&&f(a,"reset",d.proxy(this.resetForm,this))},destroy:function(){var a=this.$element;e(this.$container)||this.$container.before(a).remove();d.removeData(a.get(0));a.off("rating").removeClass("hide")},create:function(a){var c=this.$element;a=a||this.options||{};this.destroy();c.rating(a)},setTouch:function(a,c){var b,d,q,p,g,h,f;
("ontouchstart"in window||window.DocumentTouch&&document instanceof window.DocumentTouch)&&!this.inactive&&(b=a.originalEvent,d=e(b.touches)?b.changedTouches:b.touches,q=this.getPosition(d[0]),c?(this.setStars(q),this.$element.trigger("change").trigger("rating.change",[this.$element.val(),this.$caption.html()]),this.starClicked=!0):(p=this.calculate(q),g=p.val<=this.clearValue?this.fetchCaption(this.clearValue):p.caption,h=this.getWidthFromValue(this.clearValue),f=p.val<=this.clearValue?this.rtl?
100-h+"%":h+"%":p.width,this.$caption.html(g),this.$stars.css("width",f)))},initSlider:function(a){e(this.$element.val())&&this.$element.val(0);this.initialValue=this.$element.val();this.setDefault("min",this._parseAttr("min",a));this.setDefault("max",this._parseAttr("max",a));this.setDefault("step",this._parseAttr("step",a));(isNaN(this.min)||e(this.min))&&(this.min=0);(isNaN(this.max)||e(this.max))&&(this.max=5);(isNaN(this.step)||e(this.step)||0===this.step)&&(this.step=.5);this.diff=this.max-
...
"")):""},fetchCaption:function(a){var c,b,d,h,g;a=parseFloat(a);var f=this.starCaptions,k=this.starCaptionClasses;return h="function"==typeof k?k(a):k[a],d="function"==typeof f?f(a):f[a],b=e(d)?this.defaultCaption.replace(/\{rating}/g,a):d,c=e(h)?this.clearCaptionClass:h,g=a===this.clearValue?this.clearCaption:b,'\x3cspan class\x3d"'+c+'"\x3e'+g+"\x3c/span\x3e"},getWidthFromValue:function(a){var c=this.min,b=this.max;return c>=a||c===b?0:a>=b?100:100*(a-c)/(b-c)},getValueFromPosition:function(a){var c,
...
2:"Two Stars","2.5":"Two \x26 Half Stars",3:"Three Stars","3.5":"Three \x26 Half Stars",4:"Four Stars","4.5":"Four \x26 Half Stars",5:"Five Stars"},clearButtonTitle:"Clear",clearCaption:"Not Rated"};d.fn.rating.Constructor=n;d(document).ready(function(){var a=d("input.rating");a.length&&a.removeClass("rating-loading").addClass("rating-loading").rating()})});function Rating(d){this.Value;this.Step;this.MaxValue;this.Visible;this.Enabled;var e,k,g,m;this.SetAttribute=function(d){this.SetValue(d)};this.GetAttribute=function(){return g.val()};this.SetValue=function(d){this.Value=d.replace(",",".");g&&g.val(d)};this.show=function(){var h=" gx-star-rating "+(this.RatingClass||"");if(this.IsPostBack)g.rating("refresh",{readonly:!this.Enabled,step:this.Step,max:this.MaxValue,stars:this.MaxValue,ratingClass:h});else{e=d(this.getContainerControl());k=e.attr("id")+
"_rating";var f=Mustache.to_html("\x3cinput type\x3d'number' id\x3d'{{id}}' value\x3d'{{value}}'/\x3e",{id:k,value:this.Value});this.setHtml(f);h={min:0,max:this.MaxValue,stars:this.MaxValue,readonly:!this.Enabled,step:this.Step,showCaption:!1,showClear:!1,size:"sm",ratingClass:h};g=d("#"+k).rating(h);var n=this;if(this.ControlValueChanged)g.on("rating.change",function(a,c){n.ControlValueChanged()});m=g.closest(".form-group");m.length||(m=e)}m.toggle(this.Visible)}};
