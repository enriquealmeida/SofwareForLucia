...
(function () {
    ...
    * @type String
    */
    Module.CSS_MODULE = "DVelop-Module";
    ...
    */
    ...
    Module.prototype = {
        ...
        */
        ...
        /**
        * The header element, denoted with CSS class "Header"
        * @property header
        * @type HTMLElement
        */
        header: null,
        ...
        /**
        * The body element, denoted with CSS class "Body"
        * @property body
        * @type HTMLElement
        */
        body: null,
        ...
        /**
        * The footer element, denoted with CSS class "Footer"
        * @property footer
        * @type HTMLElement
        */
        footer: null,
...
(function () {
    ...
    * @type String
    */
    Overlay.CSS_OVERLAY = "DVelop-Overlay";
    ...
    YAHOO.extend(Overlay, Module, {
        ...
        */
        ...
        _setDomVisibility : function(show) {
            ...
            if (show) {
                Dom.removeClass(this.element, "dvelop-overlay-hidden");
            } else {
                Dom.addClass(this.element, "dvelop-overlay-hidden");
            }
        },
        ...
        fillHeight : function(el) {
            if (el) {
                ...
                if (validEl) {
                    ...
                    if (total === null) {
                        Dom.addClass(container, "dvelop-override-padding");
                        total = container.clientHeight; // Content, No Border, 0 Padding (set by dvelop-override-padding)
                        Dom.removeClass(container, "dvelop-override-padding");
                    }
        ...
        */
         ...
         * application/removal of a "dvelop-force-redraw" class.
         * </p>
         * <p>
        ...
        forceContainerRedraw : function() {
            var c = this;
            Dom.addClass(c.element, "dvelop-force-redraw");
            setTimeout(function() {
                Dom.removeClass(c.element, "dvelop-force-redraw");
            }, 0);
        },
        ...
        */
        onRender: function (p_sType, p_aArgs) {
            ...
            function addShadowVisibleClass() {
                Dom.addClass(this.underlay, "dvelop-tt-shadow-visible");
            ...
            function removeShadowVisibleClass() {
                Dom.removeClass(this.underlay, "dvelop-tt-shadow-visible");
            }
            ...
            function createShadow() {
                ...
                if (!oShadow) {
                    ...
                    if (!m_oShadowTemplate) {
                        ...
                        m_oShadowTemplate.className = "dvelop-tt-shadow";
                    }
         ...
         * of a dvelop-force-redraw class to the underlay element.
         * 
         * @method forceUnderlayRedraw
         */
        forceUnderlayRedraw : function() {
            var tt = this;
            Dom.addClass(tt.underlay, "dvelop-force-redraw");
            setTimeout(function() {Dom.removeClass(tt.underlay, "dvelop-force-redraw");}, 0);
        },
...
(function () {
    ...
    * @type String
    */
    Panel.CSS_PANEL_CONTAINER = "DVelop-Container";
    ...
    */
    ...
    YAHOO.extend(Panel, Overlay, {
        ...
        */
        buildMask: function () {
            ...
            if (!oMask) {
                ...
                document.MAINFORM.insertBefore(oMask, document.MAINFORM.firstChild);
        ...
        */
        ...
        forceUnderlayRedraw : function () {
            var u = this.underlay;
            Dom.addClass(u, "dvelop-force-redraw");
            setTimeout(function(){Dom.removeClass(u, "dvelop-force-redraw");}, 0);
        },
...
(function () {
    ...
    * @type String
    */
    Dialog.CSS_DIALOG = "DVelop-Dialog";
...
(function () {
    ...
    * @type String
    */
    SimpleDialog.ICON_CSS_CLASSNAME = "DVelop-Icon";
    ...
    * @type String
    */
    SimpleDialog.CSS_SIMPLEDIALOG = "DVelop-Simple-Dialog";
    ...
    ContainerEffect.FADE = function (overlay, dur) {
        ...
        fade.handleUnderlayStart = function() {
            ...
            if (underlay && YAHOO.env.ua.ie) {
                ...
                if(hasFilters) {
                    Dom.addClass(overlay.element, "dvelop-effect-fade");
                }
            }
        };
        ...
        fade.handleUnderlayComplete = function() {
            var underlay = this.overlay.underlay;
            if (underlay && YAHOO.env.ua.ie) {
                Dom.removeClass(overlay.element, "dvelop-effect-fade");
            }
        };
