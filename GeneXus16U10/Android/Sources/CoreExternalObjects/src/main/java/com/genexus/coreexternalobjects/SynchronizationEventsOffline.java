	...
	public static GXBaseCollection getEvents(Integer status) {
		...
		if (clazzGen != null) {
			...
			if (sdttypedGen != null) {
				...
				GXBaseCollection gxBaseCollectionGen = new GXBaseCollection(clazzGen, "SynchronizationEventList.SynchronizationEventListItem", "SynchronizationEvents", MyApplication.getApp().getRemoteHandle());
