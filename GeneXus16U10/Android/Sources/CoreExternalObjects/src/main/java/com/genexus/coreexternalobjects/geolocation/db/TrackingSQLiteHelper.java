...
public class TrackingSQLiteHelper extends SQLiteOpenHelper
{
    ...
    public long addLocation(Location location)
	{
        ...
        values.put(KEY_GEOLOCATION, LocationEntityFactory.createLocationEntity(location).toString() ); // Location
    ...
    public List<TrackingLocation> getAllLocations()
	{
        ...
        try
        {
        	while (cursor.moveToNext())
        	{
				...
				location.setGeolocationJson(cursor.getString(cursor.getColumnIndexOrThrow(KEY_GEOLOCATION)) );
