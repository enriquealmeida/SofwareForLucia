...
-keepclassmembers public class * extends com.artech.base.metadata.theme.ThemeClassDefinition {
   public <init>(...);
}
-keepclassmembers public class * extends com.artech.base.metadata.rules.RuleDefinition {
   public <init>(...);
}

# Constructors of user controls
-keepclassmembers class * extends android.view.View {
	public <init>(android.content.Context, com.artech.base.metadata.layout.LayoutItemDefinition);
	public <init>(android.content.Context, com.artech.ui.Coordinator, com.artech.base.metadata.layout.LayoutItemDefinition);
	public <init>(android.content.Context, com.artech.ui.Coordinator, com.artech.base.metadata.layout.GridDefinition);
}
...
-keepclassmembers class com.artech.base.metadata.expressions.GXutilPlus {
    public <methods>;
}
...
-dontnote com.artech.base.metadata.**
-dontnote com.artech.controls.**
-dontnote com.artech.fragments.**
...
-dontnote com.artech.base.model.PropertiesObject
