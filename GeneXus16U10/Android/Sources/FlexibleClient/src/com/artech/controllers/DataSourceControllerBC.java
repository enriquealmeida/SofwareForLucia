...
import static com.artech.base.metadata.enums.DisplayModes.INSERT;
...
{
	private static final String INSERT_BC_PARAM_NAME = "InitialValues";
	...
	{
		AsyncTask<Void, Void, ViewData> dataLoadingTask = new AsyncTask<Void, Void, ViewData>()
		{
			@Override
		...
		dataLoadingTask.executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR);
