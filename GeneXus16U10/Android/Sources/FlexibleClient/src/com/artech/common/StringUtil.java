...
class StringUtil extends BaseStringService implements IStringUtil
{
	...
	{
		return getDateTime(value, false, false);
	}

	@Override
	public Date getDateTime(String value, boolean isOnlyTime, boolean hasMilliseconds)
	{
	...
	@NonNull
	@Override
	public CharSequence fromHtml(@NonNull String source)
	{
	...
	@NonNull
	@Override
	public CharSequence attemptFromHtml(@NonNull String source)
	{
