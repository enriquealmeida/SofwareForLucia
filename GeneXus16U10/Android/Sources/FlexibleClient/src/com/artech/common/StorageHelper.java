...
public class StorageHelper
{
	 ...
	 */
	@NonNull
	public static File createNewFileInAppExtStorage(Context context, String subdirectory, String extension) throws IOException {
		...
		String fileName = new SimpleDateFormat("yyyy-MM-dd--HH-mm-ss-SSS", Locale.US).format(new Date());
