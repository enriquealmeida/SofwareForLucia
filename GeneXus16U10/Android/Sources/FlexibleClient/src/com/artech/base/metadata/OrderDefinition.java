...
public class OrderDefinition extends DataSourceMemberDefinition
{
	...
	private void deserialize(INodeObject jsonOrder)
	{
		...
		mBreakByUpToAttribute = MetadataLoader.getObjectName(jsonOrder.optString("@groupByUpTo", null));
		mBreakByDescriptionAttribute = MetadataLoader.getObjectName(jsonOrder.optString("@descriptionAttribute", null));
