...
class GXutilPlus
{
	...
	@NonNull
	public static BigDecimal strToNumber(String str, String decimalSeparator)
	{
	...
	{
		Pair<Double, Double> latLon = GeoFormats.tryParse(str);
		if (latLon != null)
			return GeoFormats.buildGeopoint(latLon.first, latLon.second);
		else
			return "";
	}
	...
	{
		// TODO: what other string format should be suported for geoline?
		return str;
	}
