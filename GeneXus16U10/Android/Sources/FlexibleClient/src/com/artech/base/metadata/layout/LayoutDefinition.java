	...
	implements ILayoutDefinition, ILayoutItemVisitable, Serializable
{
	...
	public ThemeApplicationBarClassDefinition getHeaderRowApplicationBarClass()
	{
		if (getTable()!=null)
		{
			return Services.Themes.getThemeClass(ThemeApplicationBarClassDefinition.class, getTable().getHeaderRowApplicationBarClass());
		}
		return null;
	}
	...
	{
		 return Services.Themes.getThemeClass(ThemeFormClassDefinition.class, mThemeClass);
	}
	...
	public void deserialize()
	{
		if (mContent != null)
		{
			...
			mActionBar = new ActionBarDefinition(this, mContent.optNode("actionBar"));
