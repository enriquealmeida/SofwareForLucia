...
public class EntityParentInfo implements Serializable
{
	...
	public static EntityParentInfo memberOf(Entity parent, String name)
	{
		return new EntityParentInfo(parent, null, name);
	}

	public static EntityParentInfo collectionMemberOf(Entity parent, String collectionName, EntityList collection)
	{
