...
public class GridDefinition extends LayoutItemDefinition
{
	...
	private ShowSelector processShowSelector(String showSelectorValue) {
		switch (showSelectorValue.toLowerCase()) {
			case "always":
			case "on action": // TODO: Should return ShowSelector.OnAction when "selection on action" works (support it's incomplete for now).
	...
	public boolean isMultipleSelectionEnabled() {
		return mIsMultipleSelectionEnabled;
	}
