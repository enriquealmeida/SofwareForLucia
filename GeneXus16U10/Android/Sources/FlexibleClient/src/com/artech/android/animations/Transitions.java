...
public class Transitions
{
	...
	static
	{
		...
		add(new Transition("gx_none", gx_none, gx_none));
		add(new Transition("gx_push_up", gx_push_up_out, gx_push_up_in));
		add(new Transition("gx_push_down", gx_push_down_out, gx_push_down_in));
		add(new Transition("gx_push_left", gx_push_left_out, gx_push_left_in));
		add(new Transition("gx_push_right", gx_push_right_out, gx_push_right_in));
		add(new Transition("gx_fade", gx_fade_out, gx_fade_in));
		...
		add(new Transition("gx_slide_up", gx_slide_caller_activity_out, gx_slide_caller_fragment_out, gx_slide_up_in, gx_slide_up_out, gx_slide_caller_activity_in));
		add(new Transition("gx_slide_down", gx_slide_caller_activity_out, gx_slide_caller_fragment_out, gx_slide_down_in, gx_slide_down_out, gx_slide_caller_activity_in));
		add(new Transition("gx_slide_left", gx_slide_caller_activity_out, gx_slide_caller_fragment_out, gx_slide_left_in, gx_slide_left_out, gx_slide_caller_activity_in));
		add(new Transition("gx_slide_right", gx_slide_caller_activity_out, gx_slide_caller_fragment_out, gx_slide_right_in, gx_slide_right_out, gx_slide_caller_activity_in));
	}
