...
public class BadgeDrawable extends Drawable {
    ...
    public void draw(Canvas canvas) {
        ...
        if (badgeMinimumWidth < badgeRadius * 2 || Build.VERSION.SDK_INT < Build.VERSION_CODES.LOLLIPOP) {
            if (mBadgePaint != null)
    ...
    public void setThemeClass(ThemeClassDefinition themeClass) {
        if (themeClass != null) {
            ...
            Typeface font = ThemeUtils.getFontFamily(themeClass.getTheme(), themeClass.getFont().getFontFamily());
