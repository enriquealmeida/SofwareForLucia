...
public class TabbedNavigationController extends AbstractNavigationController {
	...
	public Pair<View, Boolean> onPreCreate(Bundle savedInstanceState, ComponentParameters mainParams)
	{
		...
		return new Pair<View, Boolean>(mMainView ,false);
	}
	...
	private void applyThemeClass() {
		...
		if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP && mActivity.getSupportActionBar() != null) {
			...
			if (mThemeClassForTabs == null || mThemeClassForTabs.getTabStripPosition() == TabControlThemeClassDefinition.TAB_STRIP_POSITION_TOP)
	...
	private class CustomSlidingTabLayout extends SlidingTabLayout {
		...
		protected View createTabView(PagerAdapter adapter, int position) {
			...
			// support image align
			TabUtils.setTabImage(childTextView, itemInfo.definition.getImageName(), null, mDashboard.getTabsImageAlignment());
	...
	private class TabsPagerAdapter extends FragmentPagerAdapter {
		...
		public void destroyItem(ViewGroup container, int position, Object object) {
			TabItemInfo tabItem = (TabItemInfo) object;
			if (tabItem.contentFragment != null)
				super.destroyItem(container, position, tabItem.contentFragment);
			else
