...
class RemoteDataProvider implements IGxObject
{
	...
	public OutputResult execute(PropertiesObject parameters)
	{
		...
		ServiceDataResult response = Services.HttpService.getDataFromProvider(uri, null, false);
	...
	{
		return MyApplication.getApp().UriMaker.getObjectUrl(mDefinition.getName(), parameters.getInternalProperties());
	}
