...
class GxRegularVideoView extends FrameLayout implements IGxControlNotifyEvents {
	...
	private void setupLayout() {
		...
		addView(mVideoView, 0, new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT, mDefinition.getCellGravity()));
		...
		addView(mFullscreenButton, 3, new LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT, Gravity.BOTTOM | Gravity.END));
	}
	...
	private void setupMediaController() {
		...
		mediaController.setForegroundGravity(mDefinition.getCellGravity());
