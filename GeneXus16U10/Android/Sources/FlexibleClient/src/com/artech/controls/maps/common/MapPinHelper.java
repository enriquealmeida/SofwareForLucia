...
public class MapPinHelper
{
	...
	@NonNull
	public ResourceOrBitmap getPinImage(Entity item)
	{
	...
	@NonNull
	private ResourceOrBitmap loadPinResourceOrBitmap(Entity item)
	{
	...
	private ResourceOrBitmap applyPinImageClass(@NonNull ResourceOrBitmap pin)
	{
		if (pin.isNull())
			return pin;
