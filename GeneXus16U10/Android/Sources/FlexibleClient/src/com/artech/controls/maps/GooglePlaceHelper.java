...
*/	}
	...
	@Nullable
	public static
	Intent buildIntent(@NonNull Activity activity, String initialValue)
	{
		return mPickerPlacesImpl.buildIntent(activity, initialValue);
	}

	@Nullable
	public static String getLocationValueFromResult(@NonNull Context context, int resultCode, Intent data)
	{
