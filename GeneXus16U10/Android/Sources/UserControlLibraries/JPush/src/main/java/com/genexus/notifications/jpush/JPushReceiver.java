...
public class JPushReceiver extends BroadcastReceiver {
	...
	public void onReceive(Context context, Intent intent) {
        ...
        if (JPushInterface.ACTION_REGISTRATION_ID.equals(intent.getAction())) {
			...
			BadgeManager.updateBadgeCount(context, 1);
	...
	private void processExtraData(Context context, Bundle bundle)
	{
		try
		{
			...
			Intent intent = IntentFactory.createNotificationActionIntent(context, action, parameters);
	...
	/*
	@Nullable
	private JSONObject getActionJsonObject(String action, JSONArray arrayDataToProcess)
	{
		JSONObject dataToProcess = null;
