...
public class FullScreenPlayerActivity extends AppCompatActivity {
    ...
    private void applyCustomizations()
    {
        ...
        AudioPlayerThemeClassDefinition themeClass = AudioPlayerBackground.getInstance(this).getPlayerThemeClass();
        if (themeClass != null)
        {
            ThemeUtils.setFontProperties(mLine1, themeClass.getFullScreenPlayerTitleClass());
            ThemeUtils.setFontProperties(mLine2, themeClass.getFullScreenPlayerSubtitleClass());
            ThemeUtils.setFontProperties(mLine3, themeClass.getFullScreenPlayerSubtitleClass());

            ThemeClassDefinition playButtonClass = themeClass.getFullScreenPlayerPlayPauseButtonClass();
            ...
            ThemeClassDefinition otherButtonClass = themeClass.getFullScreenPlayerButtonsClass();
            ...
            ThemeClassDefinition imageClass = themeClass.getFullScreenPlayerImageClass();
            if (imageClass != null)
            {
