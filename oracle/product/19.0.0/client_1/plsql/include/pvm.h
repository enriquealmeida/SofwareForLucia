...
/* 
   ...
   MODIFIED   (MM/DD/YY)
   orortega    09/05/18 - XbranchMerge orortega_bug-24564522 from main
   orortega    08/24/18 - 24564522: Support for ON_EMPTY clause
   orortega    01/17/18 - 26809414: Size constraint for JSON_QUERY
...
void pevm_IS_JSON(void *ctx, void *jexpr, ub4 flags, ub4 ret_dty, void *dst);
void pevm_JSON_ARRAY(void *ctx, ub2 argc, void **argv, ub4 flags, ub4 ret_dty,
                     void *dst);
void pevm_JSON_CVTBC(void *ctx, void const *src1, void *dst);
void pevm_JSON_EXISTS(void *ctx, void *jexpr, void *pathexpr, ub4 flags,
                      ub4 ret_dty, void *dst);
void pevm_JSON_OBJECT(void *ctx, ub2 argc, void **argv, ub4 flags, ub4 ret_dty,
                      void *dst);
void pevm_JSON_QUERY(void *ctx, void *jexpr, void *pathexpr, ub4 flags,
                     ub4 ret_dty, void *dst);
void pevm_JSON_VALUE(void *ctx, void *jexpr, void *pathexpr, void *format_str,
                     void *defonerror, void* defonempty, ub4 flags, ub4 ret_dty,
                     void *dst);
