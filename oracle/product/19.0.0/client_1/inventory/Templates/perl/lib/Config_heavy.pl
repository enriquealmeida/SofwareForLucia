...
baserev='5'
bash=''
bin='%ORACLE_HOME%\perl\bin'
binexp='%ORACLE_HOME%\perl\bin'
bison=''
byacc='byacc'
byteorder='1234'
c=''
...
installhtml1dir=''
installhtml3dir=''
installhtmldir='%ORACLE_HOME%\perl\html'
installhtmlhelpdir='%ORACLE_HOME%\perl\htmlhelp'
installman1dir='%ORACLE_HOME%\perl\man\man1'
installman3dir='%ORACLE_HOME%\perl\man\man3'
installprefix='%ORACLE_HOME%\perl'
installprefixexp='%ORACLE_HOME%\perl'
...
ksh=''
ld='link'
lddlflags='-dll -nologo -nodefaultlib -debug -opt:ref,icf  -libpath:"%ORACLE_HOME%\perl\lib\CORE"  -machine:x86 "/manifestdependency:type='Win32' name='Microsoft.Windows.Common-Controls' version='6.0.0.0' processorArchitecture='*' publicKeyToken='6595b64144ccf1df' language='*'"'
ldflags='-nologo -nodefaultlib -debug -opt:ref,icf  -libpath:"%ORACLE_HOME%\perl\lib\CORE"  -machine:x86 "/manifestdependency:type='Win32' name='Microsoft.Windows.Common-Controls' version='6.0.0.0' processorArchitecture='*' publicKeyToken='6595b64144ccf1df' language='*'"'
...
mallocsrc='malloc.c'
malloctype='void *'
man1dir='%ORACLE_HOME%\perl\man\man1'
man1direxp='%ORACLE_HOME%\perl\man\man1'
man1ext='1'
man3dir='%ORACLE_HOME%\perl\man\man3'
man3direxp='%ORACLE_HOME%\perl\man\man3'
man3ext='3'
mips_type=''
mistrustnm=''
mkdir='mkdir'
...
perlpath='%ORACLE_HOME%\perl\bin\perl.exe'
pg=''
phostname='hostname'
pidtype='int'
plibpth=''
pmake=''
pr=''
prefix='%ORACLE_HOME%\perl'
prefixexp='%ORACLE_HOME%\perl'
privlib='%ORACLE_HOME%\perl\lib'
...
scriptdirexp='%ORACLE_HOME%\perl\bin'
sed='sed'
seedfunc='srand'
selectminbits='32'
...
sig_size='27'
signal_t='void'
sitearch='%ORACLE_HOME%\perl\site\lib'
sitearchexp='%ORACLE_HOME%\perl\site\lib'
sitebin='%ORACLE_HOME%\perl\site\bin'
sitebinexp='%ORACLE_HOME%\perl\site\bin'
sitehtml1dir=''
sitehtml1direxp=''
sitehtml3dir=''
sitehtml3direxp=''
sitelib='%ORACLE_HOME%\perl\site\lib'
sitelib_stem=''
...
siteprefixexp='%ORACLE_HOME%\perl\site'
sitescript=''
sitescriptexp=''
sizesize='4'
sizetype='size_t'
...
ldflags_nolargefiles='-nologo -nodefaultlib -debug -opt:ref,icf  -libpath:"%ORACLE_HOME%\perl\lib\CORE"  -machine:x86 "/manifestdependency:type='Win32' name='Microsoft.Windows.Common-Controls' version='6.0.0.0' processorArchitecture='*' publicKeyToken='6595b64144ccf1df' language='*'"'
libs_nolargefiles=''
