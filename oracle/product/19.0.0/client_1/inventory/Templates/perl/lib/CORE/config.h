 ...
 */
#define ARCHLIB "%ORACLE_HOME%\\perl\\lib"		/**/
/*#define ARCHLIB_EXP ""	/ **/
 ...
 */
#define BIN "%ORACLE_HOME%\\perl\\bin"	/**/
#define BIN_EXP "%ORACLE_HOME%\\perl\\bin"	/**/
 ...
 *	in programs that are not prepared to deal with ~ expansion at run-time.
 */
#define PRIVLIB "%ORACLE_HOME%\\perl\\lib"		/**/
 ...
 *	in programs that are not prepared to deal with ~ expansion at run-time.
 */
#define SITEARCH "%ORACLE_HOME%\\perl\\site\\lib"		/**/
/*#define SITEARCH_EXP ""	/ **/
 ...
 */
#define SITELIB "%ORACLE_HOME%\\perl\\site\\lib"		/**/
