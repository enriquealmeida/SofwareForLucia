--
-- Copyright (c) 1998-2016 by Oracle Corporation. All Rights Reserved.
--
-- NAME
--   helpus.sql
--
...
INSERT INTO SYSTEM.HELP VALUES ('CONNECT', 10, ' CONN[ECT] [{logon|/|proxy}');
INSERT INTO SYSTEM.HELP VALUES ('CONNECT', 11, ' [AS {SYSASM|SYSBACKUP|SYSDBA|SYSDG|SYSOPER|SYSRAC|SYSKM}]');
INSERT INTO SYSTEM.HELP VALUES ('CONNECT', 12, ' [edition=value]]');
INSERT INTO SYSTEM.HELP VALUES ('CONNECT', 13, NULL);
INSERT INTO SYSTEM.HELP VALUES ('CONNECT', 14, ' where logon has the following syntax:');
INSERT INTO SYSTEM.HELP VALUES ('CONNECT', 15, '     username[/password][@connect_identifier]');
INSERT INTO SYSTEM.HELP VALUES ('CONNECT', 16, NULL);
INSERT INTO SYSTEM.HELP VALUES ('CONNECT', 17, ' where proxy has the syntax:');
INSERT INTO SYSTEM.HELP VALUES ('CONNECT', 18, '     proxyuser[username][/password][@connect_identifier]');
INSERT INTO SYSTEM.HELP VALUES ('CONNECT', 19, ' NOTE: Brackets around username in proxy are required syntax');
INSERT INTO SYSTEM.HELP VALUES ('CONNECT', 20, NULL);
...
INSERT INTO SYSTEM.HELP VALUES ('HELP', 9, '     http://www.oracle.com/technology/documentation/');
INSERT INTO SYSTEM.HELP VALUES ('HELP', 10, NULL);
INSERT INTO SYSTEM.HELP VALUES ('HELP', 11, ' ******************************************************************************');
INSERT INTO SYSTEM.HELP VALUES ('HELP', 12, ' **  Top 12.2 features:                                                      **');
INSERT INTO SYSTEM.HELP VALUES ('HELP', 13, ' **    - Fast retrieval of data as CSV for use in applications like          **');
INSERT INTO SYSTEM.HELP VALUES ('HELP', 14, ' **      SQL*Loader. Use SQLPLUS -M "CSV ON" or SET MARKUP CSV ON            **');
INSERT INTO SYSTEM.HELP VALUES ('HELP', 15, ' **    - Improved defaults and optimizations for reports. Use SQLPLUS -F     **');
INSERT INTO SYSTEM.HELP VALUES ('HELP', 16, ' **    - Command recall. Use SET HISTORY ON and HISTORY to list previous     **');
INSERT INTO SYSTEM.HELP VALUES ('HELP', 17, ' **      commands.                                                           **');
INSERT INTO SYSTEM.HELP VALUES ('HELP', 18, ' ******************************************************************************');
INSERT INTO SYSTEM.HELP VALUES ('HELP', 19, NULL);
INSERT INTO SYSTEM.HELP VALUES ('HELP', 20, ' HELP|? [topic]');
INSERT INTO SYSTEM.HELP VALUES ('HELP', 21, NULL);
INSERT INTO SYSTEM.HELP VALUES ('HISTORY', 1, NULL);
INSERT INTO SYSTEM.HELP VALUES ('HISTORY', 2, ' HISTORY');
INSERT INTO SYSTEM.HELP VALUES ('HISTORY', 3, ' -------');
INSERT INTO SYSTEM.HELP VALUES ('HISTORY', 4, NULL);
INSERT INTO SYSTEM.HELP VALUES ('HISTORY', 5, ' Stores, lists, executes, edits of the commands');
INSERT INTO SYSTEM.HELP VALUES ('HISTORY', 6, ' entered during the current SQL*Plus session.');
INSERT INTO SYSTEM.HELP VALUES ('HISTORY', 7, NULL);
INSERT INTO SYSTEM.HELP VALUES ('HISTORY', 8, ' HIST[ORY] [N {RUN | EDIT | DEL[ETE]}] | [CLEAR]');
INSERT INTO SYSTEM.HELP VALUES ('HISTORY', 9, NULL);
INSERT INTO SYSTEM.HELP VALUES ('HISTORY', 10, ' N is the entry number listed in the history list.');
INSERT INTO SYSTEM.HELP VALUES ('HISTORY', 11, ' Use this number to recall, edit or delete the command.');
INSERT INTO SYSTEM.HELP VALUES ('HISTORY', 12, NULL);
INSERT INTO SYSTEM.HELP VALUES ('HISTORY', 13, ' Example:');
INSERT INTO SYSTEM.HELP VALUES ('HISTORY', 14, ' HIST 3 RUN - will run the 3rd entry from the list.');
INSERT INTO SYSTEM.HELP VALUES ('HISTORY', 15, NULL);
INSERT INTO SYSTEM.HELP VALUES ('HISTORY', 16, ' HIST[ORY] without any option will list all entries in the list.');
INSERT INTO SYSTEM.HELP VALUES ('HISTORY', 17, NULL);
...
INSERT INTO SYSTEM.HELP VALUES ('INDEX', 4, ' @             COPY         PASSWORD                 SHOW'); 
INSERT INTO SYSTEM.HELP VALUES ('INDEX', 5, ' @@            DEFINE       PAUSE                    SHUTDOWN');
INSERT INTO SYSTEM.HELP VALUES ('INDEX', 6, ' /             DEL          PRINT                    SPOOL');
INSERT INTO SYSTEM.HELP VALUES ('INDEX', 7, ' ACCEPT        DESCRIBE     PROMPT                   SQLPLUS');
INSERT INTO SYSTEM.HELP VALUES ('INDEX', 8, ' APPEND        DISCONNECT   QUIT                     START');
INSERT INTO SYSTEM.HELP VALUES ('INDEX', 9, ' ARCHIVE LOG   EDIT         RECOVER                  STARTUP');
INSERT INTO SYSTEM.HELP VALUES ('INDEX', 10, ' ATTRIBUTE     EXECUTE      REMARK                   STORE');
INSERT INTO SYSTEM.HELP VALUES ('INDEX', 11, ' BREAK         EXIT         REPFOOTER                TIMING');
INSERT INTO SYSTEM.HELP VALUES ('INDEX', 12, ' BTITLE        GET          REPHEADER                TTITLE');
INSERT INTO SYSTEM.HELP VALUES ('INDEX', 13, ' CHANGE        HELP         RESERVED WORDS (SQL)     UNDEFINE');
INSERT INTO SYSTEM.HELP VALUES ('INDEX', 14, ' CLEAR         HISTORY      RESERVED WORDS (PL/SQL)  VARIABLE');
INSERT INTO SYSTEM.HELP VALUES ('INDEX', 15, ' COLUMN        HOST         RUN                      WHENEVER OSERROR');
INSERT INTO SYSTEM.HELP VALUES ('INDEX', 16, ' COMPUTE       INPUT        SAVE                     WHENEVER SQLERROR');
INSERT INTO SYSTEM.HELP VALUES ('INDEX', 17, ' CONNECT       LIST         SET                      XQUERY');
...
INSERT INTO SYSTEM.HELP VALUES ('PRINT', 8, ' PRINT [variable ...]');
...
INSERT INTO SYSTEM.HELP VALUES ('SET', 24, '   CMDS[EP] {;|c|OFF|ON}                    ROWPREF[ETCH] {n}');
INSERT INTO SYSTEM.HELP VALUES ('SET', 25, '   COLINVI[SIBLE] {OFF|ON}                  SERVEROUT[PUT] {ON|OFF}');
INSERT INTO SYSTEM.HELP VALUES ('SET', 26, '   COLSEP {_|text}                            [SIZE {n | UNLIMITED}]|');
INSERT INTO SYSTEM.HELP VALUES ('SET', 27, '   CON[CAT] {.|c|ON|OFF}                      [FOR[MAT]  {WRA[PPED]|');
INSERT INTO SYSTEM.HELP VALUES ('SET', 28, '   COPYC[OMMIT] {0|n}                          WOR[D_WRAPPED]|TRU[NCATED]}]');
INSERT INTO SYSTEM.HELP VALUES ('SET', 29, '   COPYTYPECHECK {ON|OFF}                   SHIFT[INOUT] {VIS[IBLE] |');
INSERT INTO SYSTEM.HELP VALUES ('SET', 30, '   DEF[INE] {&|c|ON|OFF}                      INV[ISIBLE]}');
INSERT INTO SYSTEM.HELP VALUES ('SET', 31, '   DESCRIBE [DEPTH {1|n|ALL}]               SHOW[MODE] {OFF|ON}');
INSERT INTO SYSTEM.HELP VALUES ('SET', 32, '     [LINENUM {OFF|ON}] [INDENT {OFF|ON}]   SQLBL[ANKLINES] {OFF|ON}');
INSERT INTO SYSTEM.HELP VALUES ('SET', 33, '   ECHO {OFF|ON}                            SQLC[ASE] {MIX[ED] |');
INSERT INTO SYSTEM.HELP VALUES ('SET', 34, '   EDITF[ILE] file_name[.ext]                 LO[WER] | UP[PER]}');
INSERT INTO SYSTEM.HELP VALUES ('SET', 35, '   EMB[EDDED] {OFF|ON}                      SQLCO[NTINUE] {> | text}');
INSERT INTO SYSTEM.HELP VALUES ('SET', 36, '   ERRORL[OGGING] {ON|OFF}                  SQLN[UMBER] {ON|OFF}');
INSERT INTO SYSTEM.HELP VALUES ('SET', 37, '     [TABLE [schema.]tablename]             SQLPLUSCOMPAT[IBILITY] {x.y[.z]}');
INSERT INTO SYSTEM.HELP VALUES ('SET', 38, '     [TRUNCATE] [IDENTIFIER identifier]     SQLPRE[FIX] {#|c}');
INSERT INTO SYSTEM.HELP VALUES ('SET', 39, '   ESC[APE] {\|c|OFF|ON}                    SQLP[ROMPT] {SQL>|text}');
INSERT INTO SYSTEM.HELP VALUES ('SET', 40, '   ESCCHAR {@|?|%|$|OFF}                    SQLT[ERMINATOR] {;|c|ON|OFF}');
INSERT INTO SYSTEM.HELP VALUES ('SET', 41, '   EXITC[OMMIT] {ON|OFF}                    STATEMENTC[ACHE] {n}');
INSERT INTO SYSTEM.HELP VALUES ('SET', 42, '   FEED[BACK] {6|n|ON|OFF|ONLY}[SQL_ID]     SUF[FIX] {SQL|text}');
INSERT INTO SYSTEM.HELP VALUES ('SET', 43, '   FLAGGER {OFF|ENTRY|INTERMED[IATE]|FULL}  TAB {ON|OFF}');
INSERT INTO SYSTEM.HELP VALUES ('SET', 44, '   FLU[SH] {ON|OFF}                         TERM[OUT] {ON|OFF}');
INSERT INTO SYSTEM.HELP VALUES ('SET', 45, '   HEA[DING] {ON|OFF}                       TI[ME] {OFF|ON}');
INSERT INTO SYSTEM.HELP VALUES ('SET', 46, '   HEADS[EP] {||c|ON|OFF}                   TIMI[NG] {OFF|ON}');
INSERT INTO SYSTEM.HELP VALUES ('SET', 47, '   HIST[ORY] {ON|OFF|N}                     TRIM[OUT] {ON|OFF}');
INSERT INTO SYSTEM.HELP VALUES ('SET', 48, '   INSTANCE [instance_path|LOCAL]           TRIMS[POOL] {OFF|ON}');
INSERT INTO SYSTEM.HELP VALUES ('SET', 49, '   LIN[ESIZE] {80|n|WINDOW}                 UND[ERLINE] {-|c|ON|OFF}');
INSERT INTO SYSTEM.HELP VALUES ('SET', 50, '   LOBOF[FSET] {1|n}                        VER[IFY] {ON|OFF}');
INSERT INTO SYSTEM.HELP VALUES ('SET', 51, '   LOBPREF[ETCH] {n}                        WRA[P] {ON|OFF}');
INSERT INTO SYSTEM.HELP VALUES ('SET', 52, '   LOGSOURCE [pathname]                     XQUERY {BASEURI text|');
INSERT INTO SYSTEM.HELP VALUES ('SET', 53, '   LONG {80|n}                                ORDERING{UNORDERED|');
INSERT INTO SYSTEM.HELP VALUES ('SET', 54, '   LONGC[HUNKSIZE] {80|n}                     ORDERED|DEFAULT}|');
INSERT INTO SYSTEM.HELP VALUES ('SET', 55, '   MARK[UP] {HTML html_option|CSV csv_option} NODE{BYVALUE|BYREFERENCE|');
INSERT INTO SYSTEM.HELP VALUES ('SET', 56, '     html_option;                             DEFAULT}|CONTEXT text}' );
INSERT INTO SYSTEM.HELP VALUES ('SET', 57, '       {ON|OFF} [HEAD text] [BODY text]');
INSERT INTO SYSTEM.HELP VALUES ('SET', 58, '       [TABLE {ON|OFF}] [ENTMAP {ON|OFF}]');
INSERT INTO SYSTEM.HELP VALUES ('SET', 59, '       [SPOOL {ON|OFF}] [PRE[FORMAT] {ON|OFF}]');
INSERT INTO SYSTEM.HELP VALUES ('SET', 60, '     csv_option:');
INSERT INTO SYSTEM.HELP VALUES ('SET', 61, '       {ON|OFF} [DELIM[ITER] {c}]');
INSERT INTO SYSTEM.HELP VALUES ('SET', 62, '       [QUOTE {ON|OFF}]');
INSERT INTO SYSTEM.HELP VALUES ('SET', 63, NULL);
...
INSERT INTO SYSTEM.HELP VALUES ('SHOW', 14, '     CON_ID');
INSERT INTO SYSTEM.HELP VALUES ('SHOW', 15, '     CON_NAME');
INSERT INTO SYSTEM.HELP VALUES ('SHOW', 16, '     EDITION');
INSERT INTO SYSTEM.HELP VALUES ('SHOW', 17, '     ERR[ORS] [{ANALYTIC VIEW | ATTRIBUTE DIMENSION | HIERARCHY | FUNCTION');
INSERT INTO SYSTEM.HELP VALUES ('SHOW', 18, '        | PROCEDURE | PACKAGE | PACKAGE BODY | TRIGGER | VIEW | TYPE');
INSERT INTO SYSTEM.HELP VALUES ('SHOW', 19, '        | TYPE BODY | DIMENSION | JAVA CLASS} [schema.]name]');
INSERT INTO SYSTEM.HELP VALUES ('SHOW', 20, '     LNO');
INSERT INTO SYSTEM.HELP VALUES ('SHOW', 21, '     PARAMETERS [parameter_name]');
INSERT INTO SYSTEM.HELP VALUES ('SHOW', 22, '     PDBS');
INSERT INTO SYSTEM.HELP VALUES ('SHOW', 23, '     PNO');
INSERT INTO SYSTEM.HELP VALUES ('SHOW', 24, '     RECYC[LEBIN] [original_name]');
INSERT INTO SYSTEM.HELP VALUES ('SHOW', 25, '     REL[EASE]');
INSERT INTO SYSTEM.HELP VALUES ('SHOW', 26, '     REPF[OOTER]');
INSERT INTO SYSTEM.HELP VALUES ('SHOW', 27, '     REPH[EADER]');
INSERT INTO SYSTEM.HELP VALUES ('SHOW', 28, '     SGA');
INSERT INTO SYSTEM.HELP VALUES ('SHOW', 29, '     SPOO[L]');
INSERT INTO SYSTEM.HELP VALUES ('SHOW', 30, '     SPPARAMETERS [parameter_name]');
INSERT INTO SYSTEM.HELP VALUES ('SHOW', 31, '     SQLCODE');
INSERT INTO SYSTEM.HELP VALUES ('SHOW', 32, '     TTI[TLE]');
INSERT INTO SYSTEM.HELP VALUES ('SHOW', 33, '     USER');
INSERT INTO SYSTEM.HELP VALUES ('SHOW', 34, NULL);
...
INSERT INTO SYSTEM.HELP VALUES ('SQLPLUS', 13, '        [-M[ARKUP] markup_option] [-NOLOGINTIME] [-R[ESTRICT] {1|2|3}]');
INSERT INTO SYSTEM.HELP VALUES ('SQLPLUS', 14, '	[-S[ILENT]] ]');
INSERT INTO SYSTEM.HELP VALUES ('SQLPLUS', 15, NULL);
INSERT INTO SYSTEM.HELP VALUES ('SQLPLUS', 16, ' and where markup_option has the following syntax:');
INSERT INTO SYSTEM.HELP VALUES ('SQLPLUS', 17, '     {HTML html_options|CSV csv_options}');
INSERT INTO SYSTEM.HELP VALUES ('SQLPLUS', 18, '     See SET MARKUP command for detailed HTML and CSV options');
INSERT INTO SYSTEM.HELP VALUES ('SQLPLUS', 19, NULL);
INSERT INTO SYSTEM.HELP VALUES ('SQLPLUS', 20, ' and where logon has the following syntax:');
INSERT INTO SYSTEM.HELP VALUES ('SQLPLUS', 21, '     {username[/password][@connect_identifier] | /}');
INSERT INTO SYSTEM.HELP VALUES ('SQLPLUS', 22, '     [AS {SYSASM|SYSBACKUP|SYSDBA|SYSDG|SYSOPER|SYSRAC|SYSKM}]');
INSERT INTO SYSTEM.HELP VALUES ('SQLPLUS', 23, '     [edition=value]');
INSERT INTO SYSTEM.HELP VALUES ('SQLPLUS', 24, NULL);
INSERT INTO SYSTEM.HELP VALUES ('SQLPLUS', 25, ' and where start has the following syntax:');
INSERT INTO SYSTEM.HELP VALUES ('SQLPLUS', 26, '     @{url|filename[.ext]} [arg ...]');
INSERT INTO SYSTEM.HELP VALUES ('SQLPLUS', 27, NULL);
...
INSERT INTO SYSTEM.HELP VALUES ('STARTUP', 8, ' STARTUP db_options | cdb_options | upgrade_options');
INSERT INTO SYSTEM.HELP VALUES ('STARTUP', 9, NULL);
INSERT INTO SYSTEM.HELP VALUES ('STARTUP', 10, ' where db_options has the following syntax:');
INSERT INTO SYSTEM.HELP VALUES ('STARTUP', 11, '    [FORCE] [RESTRICT] [PFILE=filename] [QUIET] [ MOUNT [dbname] |');
INSERT INTO SYSTEM.HELP VALUES ('STARTUP', 12, '    [ OPEN [open_db_options] [dbname] ] |');
INSERT INTO SYSTEM.HELP VALUES ('STARTUP', 13, '    NOMOUNT ]');
INSERT INTO SYSTEM.HELP VALUES ('STARTUP', 14, NULL);
INSERT INTO SYSTEM.HELP VALUES ('STARTUP', 15, '    where open_db_options has the following syntax:');
INSERT INTO SYSTEM.HELP VALUES ('STARTUP', 16, '       READ {ONLY | WRITE [RECOVER]} | RECOVER');
INSERT INTO SYSTEM.HELP VALUES ('STARTUP', 17, NULL);
INSERT INTO SYSTEM.HELP VALUES ('STARTUP', 18, ' where cdb_options has the following syntax:');
INSERT INTO SYSTEM.HELP VALUES ('STARTUP', 19, '    root_connection_options | pdb_connection_options');
INSERT INTO SYSTEM.HELP VALUES ('STARTUP', 20, NULL);
INSERT INTO SYSTEM.HELP VALUES ('STARTUP', 21, ' where root_connection_options has the following syntax:');
INSERT INTO SYSTEM.HELP VALUES ('STARTUP', 22, '    PLUGGABLE DATABASE pdbname');
INSERT INTO SYSTEM.HELP VALUES ('STARTUP', 23, '    [FORCE] [RESTRICT] | [OPEN [open_pdb_options]]');
INSERT INTO SYSTEM.HELP VALUES ('STARTUP', 24, NULL);
INSERT INTO SYSTEM.HELP VALUES ('STARTUP', 25, ' where pdb_connection_options has the following syntax:');
INSERT INTO SYSTEM.HELP VALUES ('STARTUP', 26, '    [FORCE] [RESTRICT] | [OPEN [open_pdb_options]]');
INSERT INTO SYSTEM.HELP VALUES ('STARTUP', 27, NULL);
INSERT INTO SYSTEM.HELP VALUES ('STARTUP', 28, '    where open_pdb_options has the following syntax:');
INSERT INTO SYSTEM.HELP VALUES ('STARTUP', 29, '       READ WRITE | READ ONLY');
INSERT INTO SYSTEM.HELP VALUES ('STARTUP', 30, NULL);
INSERT INTO SYSTEM.HELP VALUES ('STARTUP', 31, ' and where upgrade_options has the following syntax:');
INSERT INTO SYSTEM.HELP VALUES ('STARTUP', 32, '    [PFILE=filename] {UPGRADE | DOWNGRADE} [QUIET]');
INSERT INTO SYSTEM.HELP VALUES ('STARTUP', 33, NULL);
...
INSERT INTO SYSTEM.HELP VALUES ('VARIABLE', 9, ' VAR[IABLE] [<variable> [type][=value]]');
...
INSERT INTO SYSTEM.HELP VALUES ('VARIABLE', 18, ' One can assign value to a variable for input with the new syntax');
INSERT INTO SYSTEM.HELP VALUES ('VARIABLE', 19, ' Example:');
INSERT INTO SYSTEM.HELP VALUES ('VARIABLE', 20, '   VARIABLE tmp_var VAHRCHAR2(10)=Smith');
INSERT INTO SYSTEM.HELP VALUES ('VARIABLE', 21, '   or');
INSERT INTO SYSTEM.HELP VALUES ('VARIABLE', 22, '   VARIABLE tmp_var VAHRCHAR2(10)');
INSERT INTO SYSTEM.HELP VALUES ('VARIABLE', 23, '   VARIABLE tmp_var=Smith');
INSERT INTO SYSTEM.HELP VALUES ('VARIABLE', 24, '   EXECUTE DBMS_OUTPUT.PUT_LINE(:tmp_var)');
INSERT INTO SYSTEM.HELP VALUES ('VARIABLE', 25, NULL);
